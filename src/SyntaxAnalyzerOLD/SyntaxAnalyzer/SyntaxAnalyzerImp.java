...
public class SyntaxAnalyzerImp implements SyntaxAnalyzer {
    ...
    private void optionalGeneric() throws LexicalErrorException, SyntaxErrorException {
        if(currentToken.getToken().equals("op_less")){
            match("op_less");
            optionalTypes();
            match("op_greater");
    ...
    private void match(String terminal) throws LexicalErrorException, SyntaxErrorException {
        ...
        if (currentToken.getToken().equals(terminal)) {
            ...
            System.out.println(currentToken.getLexeme()+" "+currentToken.getToken());
            throw new SyntaxErrorException( matchedToken, terminal);
        }
    }
