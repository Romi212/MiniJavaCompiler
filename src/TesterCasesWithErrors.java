...
public class TesterCasesWithErrors {
    ...
    private static final String testFilesDirectoryPath = "resources/exampleWithErrors/";
    ...
    public TesterCasesWithErrors(String input){
        this.input = input;
    }
